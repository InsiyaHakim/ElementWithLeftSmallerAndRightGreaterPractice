const ElementWithLeftSmallerAndRightGreater = (arr) => {
    ...
    //we are starting with last element and comparing if other elements are smaller than that
            //0(1) assignment of i in loop
    for(let i = arr.length -1; i >= 0; i--){ //0(n) for loop
...
console.log(ElementWithLeftSmallerAndRightGreater([4,3,2,7,8,9])); // 7
console.log(ElementWithLeftSmallerAndRightGreater([ 5, 1, 4, 3, 6, 8, 10, 7, 9 ])); // 6
console.log(ElementWithLeftSmallerAndRightGreater([ 5, 1, 4, 4 ])); // -1
